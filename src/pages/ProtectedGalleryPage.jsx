      ...
      <AnimatePresence mode="wait">
        {!isUnlocked ? (
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <div className="p-8 rounded-xl bg-accent-900/30 border border-accent-700/30 backdrop-blur-sm">
              <div className="flex justify-center mb-6">
                <div className="p-4 rounded-full bg-accent-800/50 border border-accent-700/50">
              ...
              <p className="text-accent-400 text-center mb-8">
              ...
              <form onSubmit={handleUnlock} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded-lg border border-accent-700/50 bg-accent-800/50 text-white placeholder-accent-500 focus:border-accent-500 focus:outline-none uppercase tracking-wider text-center text-lg"
                    autoFocus
                  />
                </div>
                ...
                <motion.button
                  type="submit"
                  className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-primary-600 to-accent-600 text-white font-medium hover:from-primary-500 hover:to-accent-500 transition-all flex items-center justify-center gap-2"
              ...
              <div className="mt-6 p-4 rounded-lg bg-accent-800/30 border border-accent-700/30">
                <p className="text-sm text-accent-400 text-center mb-2">
                  💡 Pour tester cette démo, utilisez:
                </p>
                <p className="text-xs text-accent-500 text-center font-mono">
            ...
            {/* Info Section */}
            <div className="mt-8 p-6 rounded-xl bg-accent-900/20 border border-accent-700/20">
          ...
          >
            {/* Gallery Header */}
            <div className="mb-8 p-6 rounded-xl bg-accent-900/30 border border-accent-700/30">
              <div className="flex items-center justify-between mb-4">
                ...
                <motion.button
                  ...
                  className="px-4 py-2 rounded-lg border border-accent-700/50 text-accent-300 hover:border-accent-600 hover:text-white transition-all"
              ...
              <div className="flex flex-wrap gap-3">
                <motion.button
                  className="px-4 py-2 rounded-lg bg-accent-800/50 border border-accent-700/50 text-accent-300 hover:border-accent-600 hover:text-white transition-all flex items-center gap-2"
                  whileHover={{ scale: 1.02 }}
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {demoPhotos.map((photo, index) => (
                <motion.div
                  key={photo.id}
                  className="aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-primary-900 to-accent-900 border border-accent-700/30 cursor-pointer group relative"
                ...
                >
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <span className="text-accent-500/30 text-xs">Photo {photo.id}</span>
                  </div>
            ...
            {/* Download Info */}
            <div className="mt-8 p-4 rounded-lg bg-accent-900/20 border border-accent-700/20 text-center">
